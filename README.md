...
<p align="center">
  ...
  多 Provider · Chat/Build 多会话 · 项目级记忆 · 子代理派遣 · Scheduler · Codex 风格桌面 WebUI
</p>
...
| <img src="assets/tools/tool-subagent.png" width="20" alt="" /> | `spawn_teammate`          | Build 项目级内部 Team 召入队友 | ✗ |
| <img src="assets/tools/tool-subagent.png" width="20" alt="" /> | `list_teammates`          | 查看当前 Build 项目 Team 状态 | ✓ |
| <img src="assets/tools/tool-subagent.png" width="20" alt="" /> | `send_message`            | 向项目 Team inbox 留言        | ✗ |
| <img src="assets/tools/tool-subagent.png" width="20" alt="" /> | `read_inbox`              | 读取当前 actor 的 inbox       | ✗（默认会移动已读游标） |
| <img src="assets/tools/tool-subagent.png" width="20" alt="" /> | `broadcast`               | 向当前项目多个队友广播并可逐个唤醒 | ✗ |
