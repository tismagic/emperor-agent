import type { ModelConfigPayload, ModelDiscoveryResult, ModelTestResult } from '../types'
...
export async function discoverProviderModels(settings: Record<string, unknown>): Promise<ModelDiscoveryResult> {
  return invokeCore('model.discoverModels', settings) as Promise<ModelDiscoveryResult>
}
